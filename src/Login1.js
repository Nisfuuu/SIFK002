    ...
    <div className="login-register-background">
      <form className="form" onSubmit={handleLogin}>
        ...
        <video className="gembok" autoPlay loop muted>
          <source src="/gembok.webm" type="video/webm" />
        ...
        <div className="field">
          ...
          <input autoComplete="off" placeholder="Email" className="input-field" type="email" value={email} onChange={(e) => setEmail(e.target.value)} />
        </div>
        <div className="field">
          <svg className="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        {error && <p className="error-message">Gmail/Password salah...!</p>}
        <button type="submit" className="button2">
          Login
        </button>
        <button type="submit" className="button2" onClick={() => navigate("/register")}>
          Register
        </button>
